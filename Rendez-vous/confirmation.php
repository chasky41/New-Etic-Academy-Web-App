...
<body>
    <div class="container mt-5">
        <div class="alert alert-success" role="alert">
            ...
            <p>Vous avez envoyé la demande de rendez-vous avec succès. Un conseiller va vous contacter dans les meilleurs délais.</p>
            <hr>
            <p class="mb-0">Merci pour votre patience et à bientôt!</p>
        </div>
    </div>
